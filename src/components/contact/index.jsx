                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                <h3 className="text-lg font-semibold text-gray-800">{translate('contact.info.address.label')}</h3>
                                <p className="text-gray-600">{translate('contact.info.address.value')}</p>
                            </div>
                        </div>
                        <div className="flex items-start space-x-4">
                            <svg className="w-6 h-6 text-blue-600 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                <h3 className="text-lg font-semibold text-gray-800">{translate('contact.info.phone.label')}</h3>
                                <p className="text-gray-600">{translate('contact.info.phone.value')}</p>
                            </div>
                        </div>
                        <div className="flex items-start space-x-4">
                            <svg className="w-6 h-6 text-blue-600 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
