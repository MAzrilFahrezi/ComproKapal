...
export default function Services() {
    ...
    return (
        <section className="relative py-24 bg-blue-900 overflow-hidden">
            ...
            <div className="absolute top-10 right-10 w-64 h-64 rounded-full bg-blue-700 opacity-20 animate-pulse"></div>
            <div className="absolute bottom-10 left-10 w-48 h-48 rounded-full bg-blue-600 opacity-20 animate-pulse"></div>
