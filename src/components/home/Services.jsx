    ...
    const services = [
        {
            ...
            title: translate('home.services.shipSurvey.title'),
            description: translate('home.services.shipSurvey.description'),
            mainPoints: translate('home.services.shipSurvey.points'),
            bgColor: "from-blue-600 to-blue-800",
            hoverColor: "group-hover:from-blue-700 group-hover:to-blue-900"
        },
        {
            icon: <FaClipboardCheck className="w-12 h-12 text-white" />,
            title: translate('home.services.cargoSurvey.title'),
            description: translate('home.services.cargoSurvey.description'),
            mainPoints: translate('home.services.cargoSurvey.points'),
